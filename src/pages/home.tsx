...
export default function Home() {
	...
	const header = (
		<div className="flex flex-col md:flex-row items-center gap-4 mb-6 p-4 bg-gray-100 rounded-lg shadow-md">
			...
			<InputText
				...
				className="w-full md:w-2/5 border-2 border-gray-300 rounded-lg p-2"
			/>
		</div>
	);

	const bookTemplate = (book: Book) => {
		const [isCarouselImageLoading, setIsCarouselImageLoading] =
			useState(true);
			...
			>
				{selectedBook ? (
					<div className="p-4 flex flex-col items-center">
						...
						<p className="text-lg text-gray-700 mb-1">
							Idiomas:{" "}
							{selectedBook.editions_language?.join(", ") ||
								"N/A"}
						</p>
					</div>
				) : (
